...
This repository contains 79 specialized subagents that extend Claude Code's capabilities. Each subagent is an expert in a specific domain, automatically invoked based on context or explicitly called when needed. All agents are configured with specific Claude models based on task complexity for optimal performance and cost-effectiveness.
...
- **[react-architect](react-architect.md)** - React systems expert with deep knowledge of effects, hooks, reconciliation, and performance patterns
- **[react-native-architect](react-native-architect.md)** - React Native mastery including bridge architecture, native modules, and mobile performance
- **[ui-ux-designer](ui-ux-designer.md)** - Create interface designs, wireframes, and design systems
- **[web-ux-architect](web-ux-architect.md)** - Web UX mastery including accessibility (WCAG), responsive design, and browser behavior
- **[mobile-ux-architect](mobile-ux-architect.md)** - Mobile-first UX including touch interactions, platform conventions, and thumb zones
- **[desktop-ux-specialist](desktop-ux-specialist.md)** - Desktop UX including keyboard navigation, window management, and power user workflows
- **[wearable-ux-specialist](wearable-ux-specialist.md)** - Wearable UX including glanceable design, complications, and micro-interactions
...
- **[ruby-master](ruby-master.md)** - Ruby and Rails mastery including metaprogramming, ActiveRecord internals, and performance optimization
...
- **[shell-wizard](shell-wizard.md)** - Shell scripting mastery across bash, zsh, and sh with POSIX compliance and portability
- **[powershell-master](powershell-master.md)** - PowerShell mastery including .NET integration, Windows administration, and DSC
- **[swift-master](swift-master.md)** - Swift mastery including protocol-oriented programming, concurrency, and SwiftUI patterns
- **[objective-c-legacy-expert](objective-c-legacy-expert.md)** - Objective-C mastery including manual memory management, runtime, and UIKit patterns
- **[android-architect](android-architect.md)** - Native Android architecture including Kotlin coroutines, Jetpack Compose, and platform internals
...
- **[docker-architect](docker-architect.md)** - Docker mastery including multi-stage builds, security, and production containerization
- **[github-actions-architect](github-actions-architect.md)** - GitHub Actions mastery including workflow optimization, security, and reusable workflows
...
- **[wsl-integration-specialist](wsl-integration-specialist.md)** - WSL2 mastery including Windows/Linux interop, file system performance, and cross-platform development
- **[vscode-extension-architect](vscode-extension-architect.md)** - VSCode extension mastery including LSP, DAP, and extension API patterns
...
- **[backend-optimization-master](backend-optimization-master.md)** - Backend performance mastery including database optimization, caching, and scalability
- **[frontend-optimization-master](frontend-optimization-master.md)** - Frontend performance mastery including Core Web Vitals, bundle optimization, and rendering
...
- **[notion-api-specialist](notion-api-specialist.md)** - Notion API mastery including database operations, automation, and integrations
- **[figma-automation-architect](figma-automation-architect.md)** - Figma API and plugin mastery including design tokens and automated handoff
